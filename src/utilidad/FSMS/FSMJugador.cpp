...
FSMJugador* EstadoJugadorInitBrinco::input_handle(KeyOyente& input, MouseOyente& mouse)
{
...
FSMJugador* EstadoJugadorSubeBrinco::input_handle(KeyOyente& input, MouseOyente& mouse)
{
    if(llego)
...
FSMJugador* EstadoJugadorBajaBrinco::input_handle(KeyOyente& input, MouseOyente& mouse)
{
    if(llego)
        return new EstadoJugadorIDLE();
    return NULL;
...
FSMJugador* EstadoJugadorLerpBrinco::input_handle(KeyOyente &input, MouseOyente &mouse)
{
