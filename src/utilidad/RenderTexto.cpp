...
void RenderTexto::render_texto(SDL_Renderer *ren, int x, int y,
                               std::string texto, int fontsize, SDL_Color color,
                               std::string font) {
  // Agregar el font
  ...
  SDL_Surface *surf_texto =
      TTF_RenderText_Blended(fontTipo, texto.c_str(), color);
  // La convertimos en textura
  SDL_Texture *textexto = SDL_CreateTextureFromSurface(ren, surf_texto);
...
void RenderTexto::render_texto(SDL_Renderer *ren, int x, int y,
                               std::string texto, int w, int h,
                               SDL_Color color) {
  // pixeles
  get().font_surface =
      TTF_RenderText_Blended(get().font_default, texto.c_str(), color);
